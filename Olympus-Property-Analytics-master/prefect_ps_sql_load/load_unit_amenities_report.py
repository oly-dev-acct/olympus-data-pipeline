...
logging.basicConfig(
    filename="load_unit_amenities_report_postgres.log",
    level=logging.DEBUG,
...
@task(name="load_unit_amenities_report_postgres")
def main():
    ...
    ps_sql.insert_dataframe(os.getenv("UNIT_AMENITIES_REPORT_TABLE_NAME"), unit_amenties_report_data.df)
