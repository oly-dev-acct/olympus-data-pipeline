...
from transform_data import BIRentGrataUnpaidRewards
import logging
...
logging.basicConfig(
    filename="load_rent_grata_unpaid_reward_report_postgres.log",
    level=logging.DEBUG,
...
@task(name="load_rent_grata_unpaid_reward_report_postgres")
def main():
