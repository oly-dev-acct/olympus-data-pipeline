...
logging.basicConfig(
    filename="load_google_reviews_postgres.log",
    level=logging.DEBUG,
...
@task(name="load_google_reviews_postgres")
def main():
    ...
    ps_sql.insert_dataframe(os.getenv("GOOGLE_REVIEW_TABLE_NAME"), google_review_data.df)
