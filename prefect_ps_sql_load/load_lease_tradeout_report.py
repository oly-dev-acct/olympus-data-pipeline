...
logging.basicConfig(
    filename="load_lease_tradeout_report_postgres.log",
    level=logging.DEBUG,
...
@task(name="load_lease_tradeout_report_postgres")
def main():
    ...
    ps_sql.insert_dataframe_copy_command(os.getenv("LEASE_TRADE_REPORT_TABLE_NAME"), lease_trade_report_data.df)
