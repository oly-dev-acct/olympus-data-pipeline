...
load_dotenv()
logging.basicConfig(
    filename="manual_workflow_postgres.log",
    level=logging.DEBUG,
...
def process_finance_statements_to_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
...
def load_availability_turnover_to_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
...
def load_all_units_lease_deatails_lease_expiration_to_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
...
def load_unit_availbility_report_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
...
def load_lease_report_ps_sql():
    ...
    lease_report_data = LeasereportData(os.getenv("LEASE_REPORT_FOLDER_PATH"))
    lease_report_data.structurize_data()
    ps_sql.insert_dataframe(os.getenv("LEASE_REPORT_TABLE_NAME"), lease_report_data.df)
    elapsed_time = time.time() - start_time
    logging.info(
        f'Sucessfully staged all data to {os.getenv("LEASE_REPORT_TABLE_NAME")}: Elapsed time {elapsed_time:.2f} seconds'
    )
...
def load_service_requests_new_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
    ...
    service_request_report_data = ServiceRequestData(os.getenv("SERVICE_REQUESTS_REPORT_FOLDER_PATH"))
    service_request_report_data.structurize_data()
    ps_sql.insert_dataframe(os.getenv("SERVICE_REQUESTS_REPORT_TABLE_NAME"), service_request_report_data.df)
...
def load_market_rate_report_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
    ...
    market_rate_report_data = MarketRateReportData(os.getenv("MARKET_RATE_REPORT_FOLDER_PATH"))
    market_rate_report_data.structurize_data()
    ps_sql.insert_dataframe(os.getenv("MARKET_RATE_REPORT_TABLE_NAME"), market_rate_report_data.df)
    elapsed_time = time.time() - start_time
    logging.info(
        f'Sucessfully staged all data to {os.getenv("MARKET_RATE_REPORT_TABLE_NAME")}: Elapsed time {elapsed_time:.2f} seconds'
    )

def load_unit_setup_view_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
...
def load_acquisition_entities_propertyinfo_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
...
def load_unit_renewal_offer_report_ps_sql():
    ps_sql = PostgreSQL(host=os.getenv("PS_SERVER_NAME"), database=os.getenv("PS_DATABASE_NAME"),user=os.getenv("PS_USER_NAME"), password=os.getenv("PS_PASSWORD"), schema=os.getenv("PS_SCHEMA"))
    ps_sql.connect()
    ps_sql.truncate_tables(
        {
    ...
    unit_renewal_offer_data = UnitRenewalOfferAnalysis(os.getenv("UNIT_RENEWAL_OFFER_ANALYSIS_REPORT_FOLDER_PATH"))
    unit_renewal_offer_data.structurize_data()
    ps_sql.insert_dataframe(os.getenv("UNIT_RENEWAL_OFFER_ANALYSIS_REPORT_TABLE_NAME"), unit_renewal_offer_data.df)
    elapsed_time = time.time() - start_time
    logging.info(
        f'Sucessfully staged all data to {os.getenv("UNIT_RENEWAL_OFFER_ANALYSIS_REPORT_TABLE_NAME")}: Elapsed time {elapsed_time:.2f} seconds'
    )

def load_unit_availbility_report_new():
    ms_sql = MSSQL(server=os.getenv("SERVER_NAME"), database=os.getenv("DATABASE_NAME"))
    ms_sql.connect()
    ms_sql.truncate_tables(
        {
...
def load_staging():
    ...
    #process_finance_statements_to_ps_sql()
    #load_availability_turnover_to_ps_sql()
    #load_all_units_lease_deatails_lease_expiration_to_ps_sql()
    #load_unit_availbility_report_ps_sql()
    #load_lease_report_ps_sql()
    #load_service_requests_new_ps_sql()
    #load_requests_ps_sql()
    #load_market_rate_report_ps_sql()
    #load_unit_setup_view_ps_sql()
    #load_acquisition_entities_propertyinfo_ps_sql()
    #load_requests_ps_sql()
    #load_unit_renewal_offer_report_ps_sql()
    load_unit_availbility_report_new()
